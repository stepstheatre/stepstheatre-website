  ...
  return (
    <div className="bg-gray-900">
      <main className="relative isolate">
        <div
          aria-hidden="true"
          className="absolute inset-x-0 top-4 -z-10 flex transform-gpu justify-center overflow-x-hidden blur-3xl"
        >
          <div
            style={{
              clipPath:
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-40">
          ...
          <div
            aria-hidden="true"
            className="absolute inset-x-0 -top-16 -z-10 flex transform-gpu justify-center overflow-x-hidden blur-3xl"
          >
            <div
              style={{
                clipPath:
